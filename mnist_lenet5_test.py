...
# -*- coding: utf-8 -*- 
# @Time : 2019/4/14 16:58 
# @Author : Howard 
# @Site :  
# @File : mnist_lenet5_test.py 
# @Software: PyCharm
import time
...
def test(mnist):
    with tf.Graph().as_default() as g:
        ...
        y = mnist_lenet5_forward.forward(x, False, 1, None)
        ...
        while True:
            with tf.Session() as sess:
                ...
                if ckpt and ckpt.model_checkpoint_path:
                    ...
                    print('After %s train step(s), test accuracy = %g' % (global_step, accuracy_score))
                else:
